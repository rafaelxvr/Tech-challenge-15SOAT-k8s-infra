...
| Release/monitoring | [Deployment sequence](../deployment-sequence.md), [lock race test](../../tests/deployment-lock-race-contract.ps1), [monitoring](../../infra/monitoring) | Wire SharedFoundationMutation/StateBucket for shared changes; rebuild/review CLI 2.36.42 deployer digest, terminal deployment receipts and actual alert delivery. |
